...
class CanBus:
  ...
  def checkPanda() -> None:
    ...
    When using an external Panda for GM (UseRedPanda == true), the car's powertrain,
    obstacle, and camera buses are expected on the second Panda. In openpilot's
    multi-Panda layout, the second Panda's buses are offset by +4 (0/1/2/3 -> 4/5/6/7).
    """
